"""
URL patterns for the masters app.

Includes paths for managing company, location, and product data.
...
urlpatterns = [
    ...
    # path('create-user/<int:company_pk>/<int:location_pk>',
    #      views.create_customer_user, name="CreateCustomerUser"),
    ...
    path('location/detail/<int:pk>', views.location_detail, name="LocationDetail"),
    path('location/load-location', views.load_location, name="LoadLocation"),
